...
class JQRelcopy extends CWidget
{
	...
	public function init()
	{
		...
		if (!empty($this->removeText))
		{
			...
			$htmlOptions = array_merge($this->removeHtmlOptions,array('onclick'=>$onClick,'class'=>'removediv'));
		...
		if (!empty($this->jsAfterNewId2))
			$this->options['afterNewId2'] = $this->jsAfterNewId2;
