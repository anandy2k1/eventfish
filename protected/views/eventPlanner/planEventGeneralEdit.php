...
<div class="event-cat">
    <ul>
        <li class="active">
            ...
            <div class="details">
                <?php
                echo CHtml::image(Common::getEventImage($model->event_image), '', array('width' => '75px', 'height' => '75px'));
            ...
            <div class="up-photos">
                ...
                <div class="add-photos-button">
                    <span class="button-add">
                        <?php
                        echo CHtml::image(Common::getEventImage($model->event_image), '', array('width' => '240px', 'height' => '175px'));
                        echo $form->fileField($model, 'event_image'); ?>
                    </span>
