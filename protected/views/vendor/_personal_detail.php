            ...
            <ul class="uploaded-img">
                ...
                if ($model->userPhotoses):
                    ...
                    foreach ($model->userPhotoses as $omUserPhotos):
                        ?>
                        <li>
                            <?php echo CHtml::image(Common::getVendorImage($omUserPhotos->photo_url), '', array('style' => "width:26px !important;height:30px;")); ?>
            ...
            <ul class="general-form">
                ...
                <li>
                    ...
                    <!--<img src="<?php //echo Yii::app()->baseUrl;        ?>/images/proses-bg.png">-->
                        <span class="days_span"><a href="javascript:void(0);" class="daylink s_check <?php echo @strstr($model->available_days, '0') ? 'active' : ''; ?>"><input type="checkbox" id="daycheck0" class="styled" name="Users[available_days][]" <?php echo @strstr($model->available_days, '0') ? 'checked="checked"' : ''; ?> value="0"/></a></span>                            
                        <span class="days_span"><a href="javascript:void(0);" class="daylink m_check <?php echo @strstr($model->available_days, '1') ? 'active' : ''; ?>"><input type="checkbox" id="daycheck1" class="styled" name="Users[available_days][]" <?php echo @strstr($model->available_days, '1') ? 'checked="checked"' : ''; ?> value="1"/></a></span>
                        <span class="days_span"><a href="javascript:void(0);" class="daylink t_check <?php echo @strstr($model->available_days, '2') ? 'active' : ''; ?>"><input type="checkbox" id="daycheck2" class="styled" name="Users[available_days][]" <?php echo @strstr($model->available_days, '2') ? 'checked="checked"' : ''; ?> value="2"/></a></span>
                        <span class="days_span"><a href="javascript:void(0);" class="daylink w_check <?php echo @strstr($model->available_days, '3') ? 'active' : ''; ?>"><input type="checkbox" id="daycheck3" class="styled" name="Users[available_days][]" <?php echo @strstr($model->available_days, '3') ? 'checked="checked"' : ''; ?> value="3"/></a></span>
                        <span class="days_span"><a href="javascript:void(0);" class="daylink t_check <?php echo @strstr($model->available_days, '4') ? 'active' : ''; ?>"><input type="checkbox" id="daycheck4" class="styled" name="Users[available_days][]" <?php echo @strstr($model->available_days, '4') ? 'checked="checked"' : ''; ?> value="4"/></a></span>
                        <span class="days_span"><a href="javascript:void(0);" class="daylink f_check <?php echo @strstr($model->available_days, '5') ? 'active' : ''; ?>"><input type="checkbox" id="daycheck5" class="styled" name="Users[available_days][]" <?php echo @strstr($model->available_days, '5') ? 'checked="checked"' : ''; ?> value="5"/></a></span>
                        <span class="days_span"><a href="javascript:void(0);" class="daylink s_check <?php echo @strstr($model->available_days, '6') ? 'active' : ''; ?>"><input type="checkbox" id="daycheck6" class="styled" name="Users[available_days][]" <?php echo @strstr($model->available_days, '6') ? 'checked="checked"' : ''; ?> value="6"/></a></span>
                    </div>
                </li>
                <li>
