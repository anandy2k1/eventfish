...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        <div class="outer-div">
            ...
            <footer>
                <div class="container">
                    <div class="footer-block col01"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/footer-logo.png" width="164" height="67" alt="Eventfish" title="Eventfish" /></div>
                    ...
                    <div class="icon-bar">
                        ...
                        <p class="right"><a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/footer-icon01.png" width="30" height="30" /></a> <a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/footer-icon02.png" width="30" height="30" /></a> <a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/footer-icon03.png" width="30" height="30" /></a> <a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/footer-icon04.png" width="30" height="30" /></a> </p>
                    </div>
                </div>
            </footer>
            <!--footer panel ends -->
