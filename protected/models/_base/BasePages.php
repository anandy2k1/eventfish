 ...
 *
 * @property Users1 $createdUser
 * @property Users1 $updatedUser
 */
abstract class BasePages extends GxActiveRecord {
	...
	public function relations() {
		return array(
			'createdUser' => array(self::BELONGS_TO, 'Users1', 'created_user_id'),
			'updatedUser' => array(self::BELONGS_TO, 'Users1', 'updated_user_id'),
		);
	}
