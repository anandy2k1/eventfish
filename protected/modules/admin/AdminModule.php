...
class AdminModule extends CWebModule {
    ...
    public static function isEventPlanner(){
        if (Yii::app()->admin->id) {
            $amUserData = Yii::app()->admin->getState('admin');            
            if($amUserData['role_id'] == UserRole::getRoleIdAsPerType('eventplanner')){
                return true;
            }
            return false;
        }
    ...
    public static function isVendor(){
        if (Yii::app()->admin->id) {
            $amUserData = Yii::app()->admin->getState('admin');            
            if($amUserData['role_id'] == UserRole::getRoleIdAsPerType('vendor')){
                return true;
            }
            return false;
        }
